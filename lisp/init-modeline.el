...
(defun eye-mode-line-setup (&optional theme)
  ...
  (set-face-attribute 'mode-line nil :height 0.1 :background "#4a699c");;"#853910");;"#358594");;"7f5ab6")
  (set-face-attribute 'mode-line-inactive nil :height 0.1 :background "#aeb0b4")
  )
